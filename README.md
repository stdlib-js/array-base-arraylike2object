...
```javascript
arraylike2object = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-arraylike2object@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-arraylike2object@umd/bundle.js"></script>
```
